...
Important: As an alternative to the CLI commands below, you may use the Kiro Power Svelte MCP (svelte-mcp-power), if available. It provides the same set of tools.
